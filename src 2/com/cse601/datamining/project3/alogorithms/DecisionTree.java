...
public class DecisionTree {
	...
	private void CreateNode(double[][] train, int begin, int end, boolean randomForest, int numRanCols) {
		...
		tree.addNode(externalSplitGini.get(minPos).key,
                     ...
                     externalSplitGini.get(minPos).rightLabel);
		...
		CreateTree(train, externalSplitGini.get(minPos).begin, externalSplitGini.get(minPos).row, externalSplitGini.get(minPos).row+1, externalSplitGini.get(minPos).end, randomForest, numRanCols);
	}
    
	//Columnwise split of Gini 
